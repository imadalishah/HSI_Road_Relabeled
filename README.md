...
Usage of the dataset annotations must adhere to the [original HSI-Road](https://github.com/NUST-Machine-Intelligence-Laboratory/hsi_road) non-commercial and distribution license.
